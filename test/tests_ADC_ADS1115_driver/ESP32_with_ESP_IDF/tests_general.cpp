...
TEST(ADC_ADS1115_driver_esp32_esp_idf, init) {
    
}

// #define SERIAL_PORT_BAUDRATE    115200UL
// TEST(ADC_ADS1115_driver_esp32_esp_idf, initialize_ADC_driver_with_no_issues_and_INITIALIZE_SERIAL_PORT_to_communicate_errors)
// {
...
// TEST(ADC_ADS1115_driver_esp32_esp_idf, if_begin_fails_then_shows_a_message_and_hangs_the_micro_controller)
// {
//     mock().expectOneCall("Adafruit_ADS1115->begin")
...
// TEST(ADC_ADS1115_driver_esp32_esp_idf, start_new_single_reading_when_channel_is_ADC_DRIVER_CHANNEL_2)
// {
//     adc_driver->set_input_channel(adc_channel::ADC_DRIVER_CHANNEL_2);
